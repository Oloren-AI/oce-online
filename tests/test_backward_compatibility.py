...
def test_reg_0():
    ...
    assert np.allclose(model.predict(test_molecules), [ 0.5017606, -0.8976576], atol=1e-3)



def test_reg_1():
    model = get_model_for_testing("reg model 1")
    assert np.allclose(model.predict(test_molecules), [ 0.25767391, -0.15310819], atol=1e-3)



def test_reg_2():
    model = get_model_for_testing("reg model 2")
    assert np.allclose(model.predict(test_molecules), [ 0.14640912, -0.19515301], atol=1e-3)
...
def test_reg_3():
    ...
    assert np.allclose(model.predict(test_molecules), [0.5101875,  0.27005324], atol=1e-3)



def test_reg_4():
    model = get_model_for_testing("reg model 4")
    assert np.allclose(model.predict(test_molecules), [0.69562391, 0.1398656 ], atol=1e-3)
...
def test_class_1():
    ...
    assert np.allclose(model.predict(test_molecules), [1., 1.])
